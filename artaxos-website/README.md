...
## Correcciones (2) — Agosto 2026

| # | Corrección | Prioridad | Estado |
|---|---|---|---|
| 1 | Reemplazar el logo en todas sus apariciones del sitio | Alta | Hecho |
| 2 | Reemplazar las imágenes de arcos detectores | Alta | Pendiente de imágenes |
| 3 | Favicon en formato PNG | Media | Hecho |

- **1** — El logo nuevo se aplicó a las 4 apariciones (header, hero, isla móvil y footer).
  Nota: el logo nuevo es un lockup vertical (proporción 1.88:1) y el anterior era horizontal
  (4.18:1). Como el sitio dimensiona los logos por altura, sin ajuste el del footer crecía a
  620 px y el del header quedaba con la palabra "Artaxos" ilegible. Se fijaron alturas
  explícitas para que la palabra se lea en todos los tamaños.
- **3** — El favicon ahora es PNG (16, 32 y 48 px) y se declara antes del `.ico`, que queda
  solo como respaldo para navegadores antiguos. Se generó a partir del símbolo circular del
  logo: el lockup completo resulta ilegible a 16 px.

---

## Correcciones (3) — Septiembre 2026

| # | Corrección | Prioridad | Estado |
|---|---|---|---|
| 1 | Quitar la foto de la sección "¿Por Qué Artaxos?" | Alta | Hecho |
| 2 | Sustituirla por la nueva imagen | Alta | Hecho |
| 3 | Agregar el evento Grito de Independencia (Pachuca) | Alta | Hecho |

- **1 y 2** — La foto del lobby (arcos detectores, hotel XXIV) se reemplazó por la nueva
  imagen de los cinco arcos en operación. El badge "24/7 Disponible" es un elemento aparte
  y se conservó. El marcador de posición (blur) también se regeneró y el archivo anterior
  se eliminó del paquete.
- **3** — El evento se agregó al carrusel de "Eventos En Los Que Hemos Participado", con
  sus dos fotos, bajo la etiqueta **Evento cívico · Pachuca / GRITO DE INDEPENDENCIA**.
  El carrusel pasa de 6 a 7 eventos (de 14 a 16 tarjetas, duplicadas a 32 para el ciclo
  continuo).
